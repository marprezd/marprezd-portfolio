...
function SidebarTrigger({ ref, className, onClick, ...props }: React.ComponentProps<typeof Button> & { ref?: React.RefObject<React.ComponentRef<typeof Button> | null> }) {
...
function SidebarInput({ ref, className, ...props }: React.ComponentProps<typeof Input> & { ref?: React.RefObject<React.ComponentRef<typeof Input> | null> }) {
  return (
    <Input
      ref={ref}
      data-sidebar="input"
...
function SidebarSeparator({ ref, className, ...props }: React.ComponentProps<typeof Separator> & { ref?: React.RefObject<React.ComponentRef<typeof Separator> | null> }) {
  return (
    <Separator
      ref={ref}
