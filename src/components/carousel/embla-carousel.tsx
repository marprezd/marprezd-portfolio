  ...
  return (
    <div className="py-10 md:py-20">
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="mb-4 text-left text-3xl font-light">
          {t('posts.related-posts.title')}
          {' '}
          <span className="ms-2 text-lg font-medium text-gray-600 dark:text-gray-300">{t('posts.related-posts.sub-title')}</span>
        </h2>
      </div>
