...
interface UseAutoplayProgressType {
  showAutoplayProgress: boolean
}

export function useAutoplayProgress<ProgressElement extends HTMLElement>(emblaApi: EmblaCarouselType | undefined, progressNode: React.RefObject<ProgressElement | null>): UseAutoplayProgressType {
