...
export function CustomRadio(props: any) {
  ...
  return (
    <Radio
      ...
      classNames={{
        base: cn(
          'inline-flex m-0 bg-white dark:bg-gray-900 hover:bg-white/70 dark:hover:bg-gray-900/70 items-center justify-between',
        ...
        wrapper: cn(
          ...
          'border-cyan-100',
          'group-data-[hover-unselected=true]:bg-cyan-200 dark:group-data-[hover-unselected=true]:bg-gray-700',
        ),
      }}
    >
      {children}
...
export const ThemeSwitcher: FC = () => {
  ...
  return (
    <div>
      <p className="font-medium text-cyan-950 dark:text-gray-100">{t('footer.settings.theme-switcher.title')}</p>
      <div className="mt-1 flex flex-col rounded-xl bg-white p-3 text-sm dark:bg-gray-900">
